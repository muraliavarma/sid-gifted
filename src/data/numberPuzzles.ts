...
export const numberPuzzles: Question[] = [
  ...
  // ===== NEW MEDIUM (np-m-015 to np-m-022) =====
  {
    id: 'np-m-015',
    category: 'number-puzzles',
    difficulty: 'medium',
    prompt: 'Both sides must add up the same. What is the missing piece?',
    visual: makeBalanceSvg([4, 3, 2], ['?', 3], '🐙'),
    options: [
      { id: 'a', label: '4', visual: makeOptionSvg('🐙', 4) },
      { id: 'b', label: '5', visual: makeOptionSvg('🐙', 5) },
      { id: 'c', label: '6', visual: makeOptionSvg('🐙', 6) },
    ...
    correctAnswerId: 'c',
    explanation: 'Left side: 4 + 3 + 2 = 9. Right side: ? + 3 = 9. So ? = 6.',
    hint: 'Add up the left side first. Then figure out what plus 3 makes that total.',
  },
  {
    id: 'np-m-016',
    category: 'number-puzzles',
    ...
    correctAnswerId: 'b',
    explanation: 'Left side: 5 + 4 = 9. Right side: 3 + ? + 1 = 9. So 4 + ? = 9, and ? = 5.',
  },
  {
    id: 'np-m-017',
    category: 'number-puzzles',
    ...
    correctAnswerId: 'c',
    explanation: 'Left side: 3 + 4 + 3 = 10. Right side: 2 + ? = 10. So ? = 8.',
  },
  {
    id: 'np-m-018',
    category: 'number-puzzles',
    ...
    correctAnswerId: 'c',
    explanation: 'Left side: 5 + 2 + 4 = 11. Right side: ? + 3 = 11. So ? = 8.',
  },
  {
    id: 'np-m-019',
    category: 'number-puzzles',
    ...
    correctAnswerId: 'c',
    explanation: 'Left side: 4 + 3 + 4 = 11. Right side: 5 + ? = 11. So ? = 6.',
  },
  {
    id: 'np-m-020',
    category: 'number-puzzles',
    ...
    correctAnswerId: 'c',
    explanation: 'Left side: 3 + 5 + 2 = 10. Right side: 4 + ? = 10. So ? = 6.',
  },
  {
    id: 'np-m-021',
    category: 'number-puzzles',
    ...
    correctAnswerId: 'b',
    explanation: 'Left side: 2 + 4 + 3 = 9. Right side: ? + 5 = 9. So ? = 4.',
    hint: 'Add up the left side first. Then figure out what plus 5 makes that total.',
  },
  {
    id: 'np-m-022',
    category: 'number-puzzles',
    ...
    correctAnswerId: 'c',
    explanation: 'Left side: 5 + 3 + 3 = 11. Right side: 4 + ? = 11. So ? = 7.',
  },
  // ===== NEW HARD (np-h-014 to np-h-021) =====
  {
    id: 'np-h-014',
    category: 'number-puzzles',
    difficulty: 'hard',
    prompt: 'This puzzle has lots of wagons! Find the missing number.',
    visual: makeBalanceSvg([5, 4, 3, 2], [6, '?'], '🐳'),
    options: [
      { id: 'a', label: '6', visual: makeOptionSvg('🐳', 6) },
      { id: 'b', label: '7', visual: makeOptionSvg('🐳', 7) },
      { id: 'c', label: '8', visual: makeOptionSvg('🐳', 8) },
    ...
    correctAnswerId: 'c',
    explanation: 'Left side: 5 + 4 + 3 + 2 = 14. Right side: 6 + ? = 14. So ? = 8.',
    hint: 'First, add up all four numbers on the left side.',
  },
  {
    id: 'np-h-015',
    category: 'number-puzzles',
    difficulty: 'hard',
    prompt: 'Can you crack this puzzle? Both sides must be equal.',
    visual: makeBalanceSvg([4, 5, 3], ['?', 2, 4], '🌸'),
    options: [
      { id: 'a', label: '4', visual: makeOptionSvg('🌸', 4) },
      { id: 'b', label: '5', visual: makeOptionSvg('🌸', 5) },
      { id: 'c', label: '6', visual: makeOptionSvg('🌸', 6) },
    ...
    correctAnswerId: 'c',
    explanation: 'Left side: 4 + 5 + 3 = 12. Right side: ? + 2 + 4 = 12. So ? + 6 = 12, and ? = 6.',
  },
  {
    id: 'np-h-016',
    category: 'number-puzzles',
    difficulty: 'hard',
    prompt: 'Solve this tricky balance puzzle!',
    visual: makeBalanceSvg([5, 4, 5], [3, '?', 2], '🐝'),
    options: [
      { id: 'a', label: '7', visual: makeOptionSvg('🐝', 7) },
      { id: 'b', label: '8', visual: makeOptionSvg('🐝', 8) },
      { id: 'c', label: '9', visual: makeOptionSvg('🐝', 9) },
    ...
    correctAnswerId: 'c',
    explanation: 'Left side: 5 + 4 + 5 = 14. Right side: 3 + ? + 2 = 14. So 5 + ? = 14, and ? = 9.',
  },
  {
    id: 'np-h-017',
    category: 'number-puzzles',
    difficulty: 'hard',
    prompt: 'A real brain teaser! What makes both sides equal?',
    visual: makeBalanceSvg([4, 3, 5, 3], [5, '?', 2], '🎪'),
    options: [
      { id: 'a', label: '6', visual: makeOptionSvg('🎪', 6) },
      { id: 'b', label: '7', visual: makeOptionSvg('🎪', 7) },
      { id: 'c', label: '8', visual: makeOptionSvg('🎪', 8) },
    ...
    correctAnswerId: 'c',
    explanation: 'Left side: 4 + 3 + 5 + 3 = 15. Right side: 5 + ? + 2 = 15. So 7 + ? = 15, and ? = 8.',
  },
  {
    id: 'np-h-018',
    category: 'number-puzzles',
    difficulty: 'hard',
    prompt: 'This is a big puzzle! Find the missing number to balance both sides.',
    visual: makeBalanceSvg([5, 4, 3, 4], ['?', 3, 5], '🌟'),
    options: [
      { id: 'a', label: '6', visual: makeOptionSvg('🌟', 6) },
      { id: 'b', label: '7', visual: makeOptionSvg('🌟', 7) },
      { id: 'c', label: '8', visual: makeOptionSvg('🌟', 8) },
    ...
    correctAnswerId: 'c',
    explanation: 'Left side: 5 + 4 + 3 + 4 = 16. Right side: ? + 3 + 5 = 16. So ? + 8 = 16, and ? = 8.',
  },
  {
    id: 'np-h-019',
    category: 'number-puzzles',
    difficulty: 'hard',
    prompt: 'Make these trains carry the same amount!',
    visual: makeBalanceSvg([3, 5, 4, 2], [4, '?', 3], '🦋'),
    options: [
      { id: 'a', label: '5', visual: makeOptionSvg('🦋', 5) },
      { id: 'b', label: '6', visual: makeOptionSvg('🦋', 6) },
      { id: 'c', label: '7', visual: makeOptionSvg('🦋', 7) },
    ...
    correctAnswerId: 'c',
    explanation: 'Left side: 3 + 5 + 4 + 2 = 14. Right side: 4 + ? + 3 = 14. So 7 + ? = 14, and ? = 7.',
  },
  {
    id: 'np-h-020',
    category: 'number-puzzles',
    difficulty: 'hard',
    prompt: 'Solve this challenging equation! Find the missing number.',
    visual: makeBalanceSvg([4, 5, 4, 3], [3, '?', 5], '🐢'),
    options: [
      { id: 'a', label: '6', visual: makeOptionSvg('🐢', 6) },
      { id: 'b', label: '7', visual: makeOptionSvg('🐢', 7) },
      { id: 'c', label: '8', visual: makeOptionSvg('🐢', 8) },
    ...
    correctAnswerId: 'c',
    explanation: 'Left side: 4 + 5 + 4 + 3 = 16. Right side: 3 + ? + 5 = 16. So 8 + ? = 16, and ? = 8.',
  },
  {
    id: 'np-h-021',
    category: 'number-puzzles',
    difficulty: 'hard',
    prompt: 'This is a tough one! Find the missing number.',
    visual: makeBalanceSvg([5, 3, 4, 3], [2, '?', 4, 1], '🎁'),
    options: [
      { id: 'a', label: '6', visual: makeOptionSvg('🎁', 6) },
      { id: 'b', label: '7', visual: makeOptionSvg('🎁', 7) },
      { id: 'c', label: '8', visual: makeOptionSvg('🎁', 8) },
    ...
    correctAnswerId: 'c',
    explanation: 'Left side: 5 + 3 + 4 + 3 = 15. Right side: 2 + ? + 4 + 1 = 15. So 7 + ? = 15, and ? = 8.',
    hint: 'Add up both the left side and the known parts of the right side.',
  },
];
