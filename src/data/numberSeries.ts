...
export const numberSeries: Question[] = [
  ...
  // ===== NEW EASY (ns-e-008 to ns-e-012) =====
  {
    id: 'ns-e-008',
    category: 'number-series',
    difficulty: 'easy',
    prompt: 'Count the beads. What number comes next?',
    visual: makeSeriesSvg([5, 6, 7, 8, 9]),
    options: [
      { id: 'a', label: '10', visual: makeBeadOptionSvg(10) },
      { id: 'b', label: '11', visual: makeBeadOptionSvg(11) },
      { id: 'c', label: '8', visual: makeBeadOptionSvg(8) },
      { id: 'd', label: '12', visual: makeBeadOptionSvg(12) },
    ],
    correctAnswerId: 'a',
    explanation: 'The pattern is counting by 1: 5, 6, 7, 8, 9, so the next number is 10.',
    hint: 'Each rod has one more bead than the one before it.',
  },
  {
    id: 'ns-e-009',
    ...
    difficulty: 'easy',
    prompt: 'Look at the pattern. What number comes next?',
    visual: makeSeriesSvg([4, 6, 8, 10]),
    options: [
      { id: 'a', label: '11', visual: makeBeadOptionSvg(11) },
      { id: 'b', label: '14', visual: makeBeadOptionSvg(14) },
      { id: 'c', label: '12', visual: makeBeadOptionSvg(12) },
      { id: 'd', label: '13', visual: makeBeadOptionSvg(13) },
    ],
    correctAnswerId: 'c',
    explanation: 'The pattern is counting by 2: 4, 6, 8, 10, so the next number is 12.',
    hint: 'How many beads are added each time?',
  },
  {
    id: 'ns-e-010',
    category: 'number-series',
    difficulty: 'easy',
    prompt: 'The beads are getting fewer. What comes next?',
    visual: makeSeriesSvg([8, 7, 6, 5, 4]),
    options: [
      { id: 'a', label: '2', visual: makeBeadOptionSvg(2) },
      { id: 'b', label: '4', visual: makeBeadOptionSvg(4) },
      { id: 'c', label: '3', visual: makeBeadOptionSvg(3) },
      { id: 'd', label: '1', visual: makeBeadOptionSvg(1) },
    ],
    correctAnswerId: 'c',
    explanation: 'The pattern is counting down by 1: 8, 7, 6, 5, 4, so the next number is 3.',
    hint: 'Each rod has one fewer bead than the one before it.',
  },
  {
    id: 'ns-e-011',
    category: 'number-series',
    difficulty: 'easy',
    prompt: 'These numbers are going down. What comes next?',
    visual: makeSeriesSvg([12, 10, 8, 6]),
    options: [
      { id: 'a', label: '5', visual: makeBeadOptionSvg(5) },
      { id: 'b', label: '3', visual: makeBeadOptionSvg(3) },
      { id: 'c', label: '4', visual: makeBeadOptionSvg(4) },
      { id: 'd', label: '2', visual: makeBeadOptionSvg(2) },
    ],
    correctAnswerId: 'c',
    explanation: 'The pattern is counting down by 2: 12, 10, 8, 6, so the next number is 4.',
    hint: 'How many beads are removed each time?',
  },
  {
    id: 'ns-e-012',
    category: 'number-series',
    ...
    correctAnswerId: 'c',
    explanation: 'The pattern is counting by 2 (odd numbers): 3, 5, 7, 9, so the next number is 11.',
    hint: 'Each time we add the same amount. How much?',
  },
  // ===== NEW MEDIUM (ns-m-007 to ns-m-014) =====
  {
    id: 'ns-m-007',
    category: 'number-series',
    difficulty: 'medium',
    prompt: 'Study the pattern carefully. What number comes next?',
    visual: makeSeriesSvg([1, 4, 7, 10]),
    options: [
      { id: 'a', label: '12', visual: makeBeadOptionSvg(12) },
      { id: 'b', label: '13', visual: makeBeadOptionSvg(13) },
      { id: 'c', label: '14', visual: makeBeadOptionSvg(14) },
      { id: 'd', label: '11', visual: makeBeadOptionSvg(11) },
    ],
    correctAnswerId: 'b',
    explanation: 'The pattern is counting by 3: 1, 4, 7, 10, so the next number is 13.',
    hint: 'How many beads are added each time?',
  },
  {
    id: 'ns-m-008',
    category: 'number-series',
    difficulty: 'medium',
    prompt: 'These numbers jump by the same amount. What comes next?',
    visual: makeSeriesSvg([2, 6, 10, 14]),
    options: [
      { id: 'a', label: '16', visual: makeBeadOptionSvg(16) },
      { id: 'b', label: '17', visual: makeBeadOptionSvg(17) },
      { id: 'c', label: '18', visual: makeBeadOptionSvg(18) },
      { id: 'd', label: '20', visual: makeBeadOptionSvg(20) },
    ],
    correctAnswerId: 'c',
    explanation: 'The pattern is counting by 4: 2, 6, 10, 14, so the next number is 18.',
  ...
  },
  {
    ...
    difficulty: 'medium',
    prompt: 'This pattern goes up and down. What comes next?',
    visual: makeSeriesSvg([3, 5, 4, 6, 5]),
    options: [
      { id: 'a', label: '4', visual: makeBeadOptionSvg(4) },
      { id: 'b', label: '6', visual: makeBeadOptionSvg(6) },
      { id: 'c', label: '7', visual: makeBeadOptionSvg(7) },
      { id: 'd', label: '8', visual: makeBeadOptionSvg(8) },
    ],
    correctAnswerId: 'c',
    explanation: 'The pattern alternates +2, -1, +2, -1. After 5, we add 2 to get 7.',
    hint: 'Look at the up-down pattern. How much does it go up? How much does it go down?',
  },
  {
    id: 'ns-m-010',
    category: 'number-series',
    difficulty: 'medium',
    prompt: 'Find the rule. What number is next?',
    visual: makeSeriesSvg([1, 4, 3, 6, 5]),
    options: [
      { id: 'a', label: '7', visual: makeBeadOptionSvg(7) },
      { id: 'b', label: '8', visual: makeBeadOptionSvg(8) },
      { id: 'c', label: '4', visual: makeBeadOptionSvg(4) },
      { id: 'd', label: '6', visual: makeBeadOptionSvg(6) },
    ],
    correctAnswerId: 'b',
    explanation: 'The pattern alternates +3, -1, +3, -1. After 5, we add 3 to get 8.',
    hint: 'The numbers go up a lot, then down a little. By how much each way?',
  },
  {
    id: 'ns-m-011',
    category: 'number-series',
    difficulty: 'medium',
    prompt: 'This zigzag pattern has a rule. What comes next?',
    visual: makeSeriesSvg([2, 5, 3, 6, 4]),
    options: [
      { id: 'a', label: '5', visual: makeBeadOptionSvg(5) },
      { id: 'b', label: '6', visual: makeBeadOptionSvg(6) },
      { id: 'c', label: '7', visual: makeBeadOptionSvg(7) },
    ...
    correctAnswerId: 'c',
    explanation: 'The pattern alternates +3, -2, +3, -2. After 4, we add 3 to get 7.',
    hint: 'The numbers jump up then drop back. By how much each way?',
  },
  {
    id: 'ns-m-012',
    category: 'number-series',
    difficulty: 'medium',
    prompt: 'Do you see the repeating pattern? What comes next?',
    visual: makeSeriesSvg([2, 4, 2, 4, 2]),
    options: [
      { id: 'a', label: '2', visual: makeBeadOptionSvg(2) },
      { id: 'b', label: '3', visual: makeBeadOptionSvg(3) },
      { id: 'c', label: '4', visual: makeBeadOptionSvg(4) },
    ...
    correctAnswerId: 'c',
    explanation: 'The pattern repeats 2, 4, 2, 4, 2 — so the next number is 4.',
    hint: 'The numbers keep going back and forth between two values.',
  },
  {
    id: 'ns-m-013',
    category: 'number-series',
    difficulty: 'medium',
    prompt: 'These numbers count down by a larger step. What comes next?',
    visual: makeSeriesSvg([18, 15, 12, 9]),
    options: [
      { id: 'a', label: '7', visual: makeBeadOptionSvg(7) },
      { id: 'b', label: '5', visual: makeBeadOptionSvg(5) },
      { id: 'c', label: '6', visual: makeBeadOptionSvg(6) },
      { id: 'd', label: '3', visual: makeBeadOptionSvg(3) },
    ],
    correctAnswerId: 'c',
    explanation: 'The pattern is counting down by 3: 18, 15, 12, 9, so the next number is 6.',
    hint: 'How many beads are removed each time?',
  },
  {
    id: 'ns-m-014',
    category: 'number-series',
    difficulty: 'medium',
    prompt: 'Look at the repeating group. What comes next?',
    visual: makeSeriesSvg([1, 2, 3, 1, 2]),
    options: [
      { id: 'a', label: '1', visual: makeBeadOptionSvg(1) },
      { id: 'b', label: '3', visual: makeBeadOptionSvg(3) },
      { id: 'c', label: '4', visual: makeBeadOptionSvg(4) },
    ...
    correctAnswerId: 'b',
    explanation: 'The pattern repeats in groups of three: 1, 2, 3, 1, 2, — so the next number is 3.',
    hint: 'Do you see a group of numbers that keeps repeating?',
  },
  // ===== NEW HARD (ns-h-007 to ns-h-013) =====
  {
    id: 'ns-h-007',
    category: 'number-series',
    difficulty: 'hard',
    prompt: 'The jumps between numbers are growing. What comes next?',
    visual: makeSeriesSvg([4, 5, 7, 10, 14]),
    options: [
      { id: 'a', label: '17', visual: makeBeadOptionSvg(17) },
      { id: 'b', label: '18', visual: makeBeadOptionSvg(18) },
      { id: 'c', label: '19', visual: makeBeadOptionSvg(19) },
      { id: 'd', label: '20', visual: makeBeadOptionSvg(20) },
    ],
    correctAnswerId: 'c',
    explanation: 'The differences grow: +1, +2, +3, +4, so the next step is +5. 14+5=19.',
    hint: 'Find the difference between each pair. Do those differences have their own pattern?',
  },
  {
    id: 'ns-h-008',
    category: 'number-series',
    difficulty: 'hard',
    prompt: 'The gaps between numbers are shrinking. What comes next?',
    visual: makeSeriesSvg([1, 6, 10, 13, 15]),
    options: [
      { id: 'a', label: '16', visual: makeBeadOptionSvg(16) },
      { id: 'b', label: '17', visual: makeBeadOptionSvg(17) },
      { id: 'c', label: '18', visual: makeBeadOptionSvg(18) },
      { id: 'd', label: '19', visual: makeBeadOptionSvg(19) },
    ],
    correctAnswerId: 'a',
    explanation: 'The differences shrink: +5, +4, +3, +2, so the next step is +1. 15+1=16.',
    hint: 'The jumps are getting smaller each time. By how much do they shrink?',
  },
  {
    id: 'ns-h-009',
    category: 'number-series',
    difficulty: 'hard',
    prompt: 'Two patterns are mixed together. What comes next?',
    visual: makeSeriesSvg([2, 5, 4, 7, 6]),
    options: [
      { id: 'a', label: '8', visual: makeBeadOptionSvg(8) },
      { id: 'b', label: '9', visual: makeBeadOptionSvg(9) },
      { id: 'c', label: '7', visual: makeBeadOptionSvg(7) },
    ...
    correctAnswerId: 'b',
    explanation: 'Odd positions (2, 4, 6) count by 2. Even positions (5, 7, 9) count by 2. The next is an even position: 9.',
    hint: 'Look at every other number separately. Each group makes its own simple pattern.',
  },
  {
    id: 'ns-h-010',
    category: 'number-series',
    difficulty: 'hard',
    prompt: 'Each number adds together the two before it. What comes next?',
    visual: makeSeriesSvg([2, 3, 5, 8, 13]),
    options: [
      { id: 'a', label: '18', visual: makeBeadOptionSvg(18) },
      { id: 'b', label: '19', visual: makeBeadOptionSvg(19) },
      { id: 'c', label: '20', visual: makeBeadOptionSvg(20) },
      { id: 'd', label: '21', visual: makeBeadOptionSvg(21) },
    ],
    correctAnswerId: 'd',
    explanation: 'Each number is the sum of the two before it: 2+3=5, 3+5=8, 5+8=13, 8+13=21.',
    hint: 'Try adding each pair of neighbors. What do you get?',
  },
  {
    id: 'ns-h-011',
    category: 'number-series',
    difficulty: 'hard',
    prompt: 'The additions keep growing. What comes next?',
    visual: makeSeriesSvg([3, 4, 6, 9, 13]),
    options: [
      { id: 'a', label: '17', visual: makeBeadOptionSvg(17) },
      { id: 'b', label: '18', visual: makeBeadOptionSvg(18) },
      { id: 'c', label: '19', visual: makeBeadOptionSvg(19) },
    ...
    correctAnswerId: 'b',
    explanation: 'The differences grow: +1, +2, +3, +4, so the next step is +5. 13+5=18.',
    hint: 'Look at the gaps between numbers. The gaps are going up by 1 each time.',
  },
  {
    id: 'ns-h-012',
    category: 'number-series',
    difficulty: 'hard',
    prompt: 'This tricky pattern has two rules mixed in. What comes next?',
    visual: makeSeriesSvg([1, 10, 3, 8, 5]),
    options: [
      { id: 'a', label: '6', visual: makeBeadOptionSvg(6) },
      { id: 'b', label: '7', visual: makeBeadOptionSvg(7) },
      { id: 'c', label: '4', visual: makeBeadOptionSvg(4) },
    ...
    correctAnswerId: 'a',
    explanation: 'Odd positions (1, 3, 5, 7) count up by 2. Even positions (10, 8, 6) count down by 2. The next is an even position: 6.',
    hint: 'Separate the odd-position numbers from the even-position numbers. Each group has its own pattern.',
  },
  {
    id: 'ns-h-013',
    category: 'number-series',
    difficulty: 'hard',
    prompt: 'The jumps between numbers are getting smaller. What comes next?',
    visual: makeSeriesSvg([2, 8, 13, 17, 20]),
    options: [
      { id: 'a', label: '21', visual: makeBeadOptionSvg(21) },
      { id: 'b', label: '22', visual: makeBeadOptionSvg(22) },
      { id: 'c', label: '23', visual: makeBeadOptionSvg(23) },
      { id: 'd', label: '24', visual: makeBeadOptionSvg(24) },
    ],
    correctAnswerId: 'b',
    explanation: 'The differences shrink: +6, +5, +4, +3, so the next step is +2. 20+2=22.',
    hint: 'Find the difference between each pair. Are the differences getting smaller?',
  },
];
